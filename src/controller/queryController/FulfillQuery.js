...
class FulfillQuery {
    ...
    fulfillTransformations(query, result, columnsArray) {
        return this.fulfillGroup(query, result, columnsArray);
    }
    fulfillGroup(query, result, columnsArray) {
        let listOfGrouping = [];
    ...
    fulfillApplyKeys(listOfSectionGroup, query, columnsArray) {
        let result = [];
    ...
    doApplyKeyAction(sectionGroup, query, columnsArray) {
        let result = Object.create(null);
